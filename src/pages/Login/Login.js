     ...
     return (
          <div className='main flex justify-center items-center py-10'>
               <div className='max-w-4xl w-full h-full mx-3 lg:mx-0 grid grid-cols-1 md:grid-cols-2  rounded-md inner-card overflow-y-auto'>
                    ...
                    <div className="w-full h-full flex justify-center items-center lg:px-8  p-6 ">
                         <div className='w-full'>
                              ...
                              <form onSubmit={handleSubmit(handleLogin)} className="mt-6">
                                   <div>
                                        ...
                                        <input {...register('email', { required: 'Email adress is required' })} type="email" className="block w-full px-4 py-2 mt-2 text-gray-700 sidebar border border-gray-200 rounded-md  focus:border-rose-400 focus:ring-gray-300 focus:ring-opacity-40 focus:outline-none focus:ring" />
                                   ...
                                   <div className="mt-4">
                                        ...
                                        <input {...register('password', { required: 'Password is required' })} type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 sidebar border border-gray-200 rounded-md  focus:border-rose-400 focus:ring-gray-300 focus:ring-opacity-40  focus:outline-none focus:ring" />
                              ...
                              <p className="mt-8 text-xs font-light text-center text-gray-500"> Don't have an account? <Link to={'/signup'} className="font-medium text-gray-700 hover:underline">Create One</Link></p>
                         </div>
                    </div>
               </div>
