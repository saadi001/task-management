     ...
     return (
          <div className='main flex justify-center items-center py-10'>
               <div className='max-w-4xl w-full h-full mx-3 lg:mx-0 grid grid-cols-1 md:grid-cols-2  rounded-md inner-card overflow-y-auto'>
                    ...
                    <div className="w-full h-full flex justify-center items-center lg:px-8  p-6 dark:bg-gray-800">
                         <div className='w-full'>
                              ...
                              <p className="mt-8 text-xs font-light text-center text-gray-500"> Don't have an account? <Link to={'/signup'} className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</Link></p>
                         </div>
                    </div>
               </div>
